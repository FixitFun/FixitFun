...
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=cpp,)
...
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=docker,kubernetes,linux,bash,aseprite,blender,audacity,godot,unity,steam,rustrover,datagrip,clion,postgresql,supabase,redis,rust,cs,lua,py,)
